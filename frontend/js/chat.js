...
async function sendMessage() {
    ...
    try {
        ...
        addMessageToChat('Thinking...', 'bot', `typing-indicator-${typingId}`);
        ...
        const typingIndicator = document.querySelector(`.typing-indicator-${typingId}`);
        if (typingIndicator) {
